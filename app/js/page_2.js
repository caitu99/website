var rollLoad = {
    ...
    loading:function(callevent){ //触发滚动事件
        ...
        $(window).scroll(function(){
            //console.log("thiz.start:"+thiz.start);
            //console.log("thiz.totalRow:"+thiz.totalRow);
    ...
    addJsontext:function(num,callevent){ 
    	...
    	$.post(thiz.url,thiz.param,function(result){
    		if(0 == result.code){
                ...
                thiz.totalRow = result.data.datas.totalRow;
                //console.log(" result.data.datas.totalRow:"+ result.data.totalRow);
                thiz.totalRow =  result.data.totalRow;
